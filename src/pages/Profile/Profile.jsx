              ...
              <section className="profile-section">
                ...
                <form className="profile-form" onSubmit={handleProfileSave}>
                  <div className="profile-form-group">
                    <label htmlFor="username"><FaUserTag /> Username</label>
                    <input
                      id="username"
                      type="text"
                      name="username"
                  ...
                  <div className="profile-form-group">
                    <label><FaShieldAlt /> Account Role</label>
            ...
            <div className="profile-grid-column">
              ...
              <section className="profile-status-card">
                <div>
                  ...
                  <p>Your account is currently active and you can access the features available to your assigned role.</p>
                </div>
              ...
              <section className="profile-logout-section">
                <div>
                  <h2>Sign Out</h2>
                  <p>Sign out of your KnowSphere account on this device.</p>
                </div>
