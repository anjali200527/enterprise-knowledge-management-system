...
function Support() {
  ...
  return (
    <div className="support-page-wrapper">
      ...
      <main className="support-main-area">
        <header className="support-header">
          <div className="support-header-left">
            ...
            <div>
              ...
              <p>Get assistance with KnowSphere and report issues to the support team.</p>
            </div>
          </div>
        ...
        <div className="support-content">
          <section className="support-welcome">
            ...
            <div>
              <h2>Welcome to KnowSphere Support</h2>
              <p>If you are facing a technical problem or need help using any KnowSphere feature, submit a support request below.</p>
            </div>
          </section>
          ...
          <section className="support-form-section">
            <div className="support-form-heading">
              ...
              <p>Provide the details below so the support team can understand and review your issue.</p>
            </div>
          ...
          <section className="support-quick-links">
            ...
            <p>You can also visit our Help Center or Contact Us page for additional assistance.</p>
